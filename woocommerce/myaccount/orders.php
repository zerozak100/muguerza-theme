		...
		<thead>
			<tr>
				<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
					<th class="woocommerce-orders-table__header woocommerce-orders-table__header-<?php echo esc_attr( $column_id ); ?>"><span class="nobr"><?php echo $resultado = $column_name != 'Acciones' ? esc_html( $column_name ) : 'Accion'; ?></span></th>
				<?php endforeach; ?>
			</tr>
		</thead>
