...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'idcs-oda-f64c13fcbc8848cf88fd1f2881771167-da3.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '7bccb0a8-c1be-4f37-b6b7-8fa9aaa30e0e',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
